...
** Algo
   CLOCK: [2012-11-28 Wed 03:33]
   CLOCK: [2012-11-28 Wed 00:04]--[2012-11-28 Wed 02:18] =>  2:14
*** Loop
**** TODO Send operation requests for a transaction
**** TODO Wait for each ack
***** DONE Ack READ [SUCCESS | FAIL] from PID VAL
***** DONE Ack WRITE [SUCCESS | FAIL] from PID
***** DONE Yeah... subclass MutexMessage
**** TODO If rejected, restart the transaction
***** Remove timestamp from transactionTimeStampHash
**** Requests from other nodes
***** TODO execute Operation (data item)
***** TODO Send ack with the success or failure info
